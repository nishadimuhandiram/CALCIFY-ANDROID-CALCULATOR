...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener , SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //initialize gesture listener for slide to delete
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        accel = accel * 0.9f + delta; //  low-cut for shake

        // Shake detected
        if (accel > 12) {
            onShake(); //fire onShake when shake detected.
        }
    }

    private void onShake() {
        // Clear the input field when shaking the device
        textViewInputNumbers.setText("");
        Toast.makeText(this, "Oh Snap! Input cleared.", Toast.LENGTH_SHORT).show();
    ...
    //inner class for slide to delete
    ...
    private void onSwipeRight() {
        ...
        if (currentText.length() > 0) {
            textViewInputNumbers.setText(currentText.substring(0, currentText.length() - 1));
        }
    }
